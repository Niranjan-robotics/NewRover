...
def main():
  ...
  parser.add_argument(
      '--classification_model',type=str,
      default='/home/pi/projects/NewRover/all_models/niranjan_model_edgetpu.tflite',
      help='Path of classification model.')
  parser.add_argument(
      '--detection_model',
      help='Path of detection model.', type=str,
      default='/home/pi/projects/NewRover/all_models/mobilenet_ssd_v2_face_quant_postprocess_edgetpu.tflite')
  parser.add_argument('--image',type=str,default='/home/pi/projects/NewRover/all_models/Niranjan/65.jpg', help='Path of the image.')
  parser.add_argument(
      '--num_inferences',
